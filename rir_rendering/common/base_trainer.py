...
from rir_rendering.common.utils import poll_checkpoint_folder
...
class BaseRLTrainer(BaseTrainer):
    ...
    def _pause_envs(
        ...
        """
        pause envs that no longer have new episodes
        :param envs_to_pause: envs to pause
        :param envs: all envs
        :param test_recurrent_hidden_states: GRU hidden states during test
        :param not_done_masks: not-done-masks
        :param current_episode_reward: current episode reward tracker
        :param batch: observation batch
        :return: tuple with entries for paused idxs removed from different instances in the argument list
        """
